...
/**
 * Belong Updates File
 * This is the Updates handler for Belong
 *
 * @package         @packageName@
 * @version         @fileVers@
 *
 ...
 * @since		1.0.10
 */
class DunamisDunUpdates extends WordpressDunUpdates
{
	protected $_exceptions	=	array();
	protected $_expires		=	86400; // TTL
	protected $_installpath	=	null;
	protected $_url			=	'https://www.gohigheris.com/updates/dunamis/wordpress-module';
	...
	{
		$data	=	get_option( 'dunamis_update' );
	...
	protected function _updateWrite()
	{
		...
		update_option( 'dunamis_update', $data );
		return true;
	}
}